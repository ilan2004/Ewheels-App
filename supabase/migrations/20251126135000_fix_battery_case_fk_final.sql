-- Fix battery_case_id to work like vehicle_case_id
-- The FK should point to battery_cases.id, not battery_records.id
...
-- (Currently it stores battery_record_id, we need to change it to battery_case.id)
...
-- This matches how vehicle_case_id works
ALTER TABLE public.service_tickets
